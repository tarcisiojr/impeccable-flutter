...
Após escrever, **rode o loader de novo** (`node .gemini/skills/impeccable-flutter/scripts/load-context.mjs`) para a sessão pegar o DESIGN.md fresco. Comandos subsequentes vão usar.
