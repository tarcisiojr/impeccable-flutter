...
|---|---|---|
| Context | The PRODUCT.md / DESIGN.md loader result is known from `node .gemini/skills/impeccable-flutter/scripts/load-context.mjs`. | Run the loader before continuing. |
