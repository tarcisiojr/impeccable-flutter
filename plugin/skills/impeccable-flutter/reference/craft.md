...
Run /impeccable-flutter shape, passing along whatever feature description the user provided.
...
If the user has already run /impeccable-flutter shape and has a confirmed design brief, skip this step and use the existing brief.
